...
/**
   FRRMAB which uses sliding windows for each directions and share FRR information at each iteration
   - pFindNeighbor : probability to check neighbor FRR information
   - neighborTaken : Number of neighbors direction take in consideration when check neighbors FRR information
 **/
...
protected:
    ...
    */
    ...
    double D;
    // affinity weight of neighbor directions
    double neighborTaken;
    // probability to search into neighbors directions
...
private:
    ...
    /**
     * Return best next op for subProblem FFRMAB_N_FRR version
     *
