#ifndef _moQAPSolution_h
#define _moQAPSolution_h
...
/**
   ...
   + objective vector
*/
class moQAPSolution : public moSolution {
public:

  moQAPSolution(const moQAPSolution & _s) : moSolution(_s) {
    objvec = _s.objvec;
  }

  moQAPSolution& operator=(moQAPSolution & _s) {
    objvec = _s.objvec;
...
//    ss << " " << this->size() ;
   ...
   */
  bool operator< (moQAPSolution &other) {
