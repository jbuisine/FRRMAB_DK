#ifndef _moUBQPSolution_h
#define _moUBQPSolution_h
...
/**
   ...
   + objective vector
*/
class moUBQPSolution : public moSolution {
public:

  moUBQPSolution(const moUBQPSolution & _s) : moSolution(_s) {
    objvec = _s.objvec;
  }

  moUBQPSolution& operator=(moUBQPSolution & _s) {
    objvec = _s.objvec;
...
//    ss << " " << this->size() ;
   ...
   */
  bool operator< (moUBQPSolution &other) {
